...
class CharacteristicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create characteristic" do
    assert_difference('Characteristic.count') do
      post characteristics_url, params: { characteristic: { measure_unit_id: @characteristic.measure_unit_id, name: @characteristic.name, subcategory_id: @characteristic.subcategory_id } }
    end
  ...
  test "should update characteristic" do
    patch characteristic_url(@characteristic), params: { characteristic: { measure_unit_id: @characteristic.measure_unit_id, name: @characteristic.name, subcategory_id: @characteristic.subcategory_id } }
